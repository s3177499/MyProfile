...
An interesting fact about myself: I was an on-campus R.M.I.T student back on 2008, I was also the president of RMIT Indian club and a member of R.M.I.T Student Union.</p>
  ...
  <center> 
  	...
  	<h2 style="color:aqua;">    Interest in I.T </h2> 
...
The idea of this project is to develop a software or system that would reduce the risk any such attacks on A.I and prevent misuse.<br>
...
<h4 style="font-size:17px;">Risk Analysis : The product will conduct a risk analysis of the machine learning system to detect vulnerabilities.</h4><br>
<h4 style="font-size:17px;">Manupilating the system : One of the most commly seen attack on maching learning system is to fool the system into making false predictions by giving malicious inputs.Hackers manupilate AI to potray a false picute that doesn’t exist and make them to make decsions based on that .Our system will detect any such attempts and raise an alert so system can activate the measures in place to foil any such attempts.</h4><br>
<h4 style="font-size:17px;">Data manipulation : Machine learning systems depend on data for learning purposes and hackers can try to target this data source that might be in use to train machine learning systems.Failure to secure this data can increase the risk of machine learning training going haywire hence a company could benefit from a system that can protect this data and make it unaccesable to hackers.</h4><br>
<h4 style="font-size:17px;">Maipulation of online systems : Most machine learning systems are connected to the internet during operational use as it continues to learn.This gives attackers a window of oprtunity.This system can address this issue by choosing the right alogrithms,maintaing record of data ownership and securing the systems.</h4><br>
<h4 style="font-size:17px;">Data Security : Machine learning alogrithms uses data for training and learning.This data can be quite crucial as its bilt into the model and hackers will always try to find an opprtunity to break into the model and try to steal this data.If successful this can japrodize the whole machine learning process.This sytem will prevent machine learning against data extraction as well as function extraction.</h4><br>
<br>
<br>
 <p style="font-size:20px;color:#373a49;">There are several skills that i might require to learn before I can even start working on this project.Some of the skills are as follows.<br>
1. Programing language : Experience with programing language is a must .Some of the programing lanugages that might help are :Python,Java,JavaScript,C++ etc.<br>
2. Data engineering : Knowdge to store raw data gerated by systems<br>
3. Able to perform exploratory data analysis.<br>
4. Models: Proficent in machine learning algorithms and the knowdge of when to apply them.<br>
5.Security skills etc.<br>
<br>
<br>
<br>
As the demand for AI/machine learning is growing so is the risks associated. This product will ensure that the risks associated are reduced to a level where businesses and consumers can safely and fearlessly step into the world of machine learning which will have a massive impact on our future and on I.T.</p>

    <br>
    <br>
    <br>

<h3 style="color:yellow;"> References : <br>

	1.   Pega.com. 2021. What Consumers Really Think About AI: A Global Study | Pega. [online] Available at: <https://www.pega.com/ai-survey> [Accessed 3 January 2021].<br><br>

	2.   Pluralsight.com. 2021.AI/ML Essential Skills.[online] Available at: <https://www.pluralsight.com/blog/software-development/essential-skills-ml-ai-devs-aws>
          [Accessed 3 January 2021]<br><br>

     3.   Wolff, J., 2021.Available at: <https://www.brookings.edu/research/how-to-improve-cybersecurity-for-artificial-intelligence/> [Accessed 3 January 2021].. [online] Brookings.<br><br>

     4.   SEEK. 2021. [online] Available at:  <https://www.seek.com.au/job/50982320?type=promoted#searchRequestToken=4d7b069f-58ff-425d-9694-3353ae930881> [Accessed 3 January 2021].<br><br>
